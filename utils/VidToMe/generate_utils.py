...
class VidToMeGenerator(nn.Module):
    def __init__(self, pipe, scheduler, config):
        ...
        self.frame_height = config.height if hasattr(config, 'height') else None
        self.frame_width = config.width if hasattr(config, 'width') else None
...
if __name__ == "__main__":
    ...
    generator = VidToMeGenerator(pipe, scheduler, config)
